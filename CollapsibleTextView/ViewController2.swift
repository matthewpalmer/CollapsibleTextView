...
class RegionDataSource: CollapsibleTextViewDataSourceForRegionView {
    
}

class ViewController2: UIViewController, CollapsibleTextViewDataSourceForRegionViewDelegate, RegionViewDelegate {
